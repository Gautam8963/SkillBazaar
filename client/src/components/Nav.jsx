    ...
    return (
        <div className='Nav'>
            <div className="container">
                <header>
                    <div className="logo">
                        <HashLink to="/#">SkillBazaar</HashLink>
                    </div>
                    <nav>
                        <span className='menu-logo'>SkillBazaar</span>
                        <HashLink to="/#">Home</HashLink>
                        <HashLink to="/#services" smooth>Services</HashLink>
                        <HashLink to="/#aboutus" smooth>About</HashLink>
                        <HashLink to="/#contactus" smooth>Contact</HashLink>
                        {
                            loggedUser == null ?
